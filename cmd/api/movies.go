...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	//decoding into an intermediary struct to avoid the case that client provide ID and version in their requests
	var input struct {
...
func (app *application) showMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	aMovie, err := app.models.Movies.Get(id)
	...
	err = app.writeJSON(w, http.StatusOK, envelope{"movie": aMovie}, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
